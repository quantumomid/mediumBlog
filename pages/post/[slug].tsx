        ...
        <main>
            ...
            <form className="flex flex-col p-5 max-w-2xl mx-auto mb-10">
                ...
                <label className="block mb-5" htmlFor="name">
                    ...
                    <input id="name" className="shadow border rounded py-2 px-3 form-input mt-1 block w-full ring-yellow-500 outline-none focus:ring" placeholder="Omid Wakili" type="text" />
                </label>
                <label className="block mb-5" htmlFor="email">
                    <span className="text-gray-700">Email</span>
                    <input id="email" className="shadow border rounded py-2 px-3 form-input mt-1 block w-full ring-yellow-500 outline-none focus:ring" placeholder="omid@hotmail.com" type="text" />
                </label>
                <label className="block mb-5" htmlFor="comment">
                    <span className="text-gray-700">Comment</span>
                    <textarea id="comment" className="shadow border rounded py-2 px-3 form-textarea mt-1 block w-full ring-yellow-500 outline-none focus:ring" placeholder="Great points!" rows={8} />
                </label>
            </form>
        </main>
    );
